...
def train_data(bs):
    ...
    train_ds = VideoCleanDataset(train_dataset_rootdir, get_transform(train=True))
    print(train_ds)
...
def test_data(bs):
    ...
    test_ds = VideoCleanDataset(test_dataset_rootdir, get_transform(train=False))
...
def VideoCleanDatasetTest():
    ...
    ds = VideoCleanDataset(train_dataset_rootdir)
    print(ds)
    # src, tgt = ds[10]
