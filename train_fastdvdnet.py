    ...
    for epoch in range(start_epoch, args['epochs']):
        ...
        for i, data in enumerate(loader_train, 0):
            ...
            if training_params['step'] % args['save_every'] == 0:
                ...
                log_train_psnr(out_train, gt_train, loss, writer, epoch, i, num_minibatches,
                               training_params)
            # update step counter
        ...
        validate_and_log(model_temp=model,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--noise_ival",
                        nargs=2,
                        type=int,
                        default=[5, 55],
    ...
    parser.add_argument("--patch_size",
                        ...
                        default=96,
                        help="Patch size")
    parser.add_argument("--temp_patch_size",
                        "--tp",
                        type=int,
                        default=5,
                        help="Temporal patch size")
    parser.add_argument("--max_number_patches",
                        "--m",
                        type=int,
                        default=256000,
    ...
    parser.add_argument("--trainset_dir",
                        type=str,
                        default=None,
                        help='path of trainset')
    parser.add_argument("--valset_dir",
                        type=str,
                        default=None,
